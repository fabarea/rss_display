...
$tempColumns = Array (
	...
	"tx_rssdisplay_tags" => Array (		
		"exclude" => 1,		
		"label" => "LLL:EXT:rss_display/locallang_db.xml:tt_content.tx_rssdisplay_tags",		
		"config" => Array (
			"type" => "text",
			"cols" => "30",	
			"rows" => "5",
...
$TCA['tt_content']['types']['list']['subtypes_addlist'][$_EXTKEY.'_pi1']='tx_rssdisplay_feed;;;;1-1-1, tx_rssdisplay_tags, tx_rssdisplay_quantity, tx_rssdisplay_descriptionlength';


t3lib_extMgm::addPlugin(Array('LLL:EXT:rss_display/locallang_db.xml:tt_content.list_type_pi1', $_EXTKEY.'_pi1'),'list_type');


t3lib_extMgm::addStaticFile($_EXTKEY,"pi1/static/","RSS Feed");
